...
final RegExp _passwordRegExp = RegExp(r'^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9]).{8,}$');

String? validateEmail(String? value, [String? actualEmail]) {
...
String? validateDisplayName(String? value, [String? actualDisplayName]) {
  if (value == null || value.isEmpty) {
